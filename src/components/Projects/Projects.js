...
import ID1 from '../../Assets/Projects/ideelars/1.jpg';
import ID2 from '../../Assets/Projects/ideelars/2.jpg';
import ID3 from '../../Assets/Projects/ideelars/3.jpg';
import ID4 from '../../Assets/Projects/ideelars/4.jpg';

const projectData = [
  {
    title: 'iDeelars',
    imgs: [ID1, ID2, ID3, ID4],
    description: `fully functional E-commerce web application with payment methods , and portal for operations.`,
  },
  {
